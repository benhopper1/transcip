...
<div class="wrapper">
	...
	<br/>
	<div class="containerContent" style="float:le; margin-left:150px; margin-right:100px">
	
		<!-- body area for content -->
		<div class="myMenu rootVoices">
			<div id="firstVoice2" class="rootVoice {menu: 'box_menu'}" >box menu </div>
		</div>
	</div>
